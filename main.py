...
squarex=540/8
squarey=555/8
p=py.image.load('./assets/bp.png')
r=py.image.load('./assets/br.png')
n=py.image.load('./assets/bn.png')
b=py.image.load('./assets/bb.png')
k=py.image.load('./assets/bk.png')
q=py.image.load('./assets/bq.png')
P=py.image.load('./assets/wp.png')
R=py.image.load('./assets/wr.png')
N=py.image.load('./assets/wn.png')
B=py.image.load('./assets/wb.png')
K=py.image.load('./assets/wk.png')
Q=py.image.load('./assets/wq.png')
